...
<div style="width:100%;">
<div id="div_homepage" style="background-color:#32BC0A; box-shadow: -1px 9px 6px -5px rgba(191,187,191,1);">
...
<div id="div_lista_receita_despesa" style="background-color: #32BC0A;">
...
<div id="div2_lista_receita_despesa" style="background-color:#32BC0A; box-shadow: -1px 9px 6px -5px rgba(191,187,191,1);">

<div id="div_img_setaesquerda_lista">
<form action="lista_receitas_m.php" method="POST">
...
<div id="div3_lista_receita_despesa" style="background-color:#32BC0A; box-shadow: -1px 9px 6px -5px rgba(191,187,191,1);">
...
<br>
    ...
    <div id="div_lupa" style="width: 45%; position:fixed; height:35px;  top:45px; left:0; z-index:2; background-color:#32BC0A; visibility:hidden;box-shadow:0px 0px 12px 0px rgba(47, 50, 50, 0.71);">
    <input id="txt_lupa" placeholder="Busque aqui" style="background-image:none; background-color:#32BC0A; color:#FFF; margin-left:1%; margin-bottom:0; bottom:0;border-bottom-color:#FFF; width: 95%; padding-left: 2px;border-left:none;border-top:none;border-right:none; text-decoration:none; outline:none;"/>
    </div>


<div id="div_table_lista">
<?php 
	$seleciona = mysql_query("SELECT * from receitas where cd_usuario = '$cdusuario'");
	$total = 0;
	$chamados = array();
...
<?php
$receita = substr($chamado['data_receita'],5,2);
...
<a type="button" href="receita.php" class="btn_lista_despesa" style="text-decoration:none; bottom:20%; left: 50%; background-color:#32BC0A; box-shadow: -1px 3px 7px -0.5px rgba(179,179,179,1);">+</a>

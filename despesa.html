...
<body ><div id="div_total">
<form action="lista_despesas.php" method="post" class="form_despesa"name="formulario" id="form1" align="center">
<div id="div_topo_despesa_receita" style="background-color: #cd1414; box-shadow: -1px 9px 6px -5px rgba(191,187,191,1);">
...
<button type="button" style="border: 0;display: block; background-color:#cd1414;"><img src="imagens/check.png" ></img></button>
</div>
...
<br>
<input class="descrição_despes" type="text" id="icondescricao" name="descricao" placeholder="Sobre o que é esta despesa?" />
...
<input class="valor_despes" type="text" id="iconvalor" name="valor" placeholder="Insira um valor" value="" onKeyPress="return formatar_moeda(this,',','.',event);" />
...
<input type="checkbox" value="" name="cbpago" id="cb_pago"><label for="cbpago">Está pago?</label>
...
<br><br>
<input type="text" id="iconcomentario" name="comentario" placeholder="Adicionar comentário" style="margin-left:0;"/><img src="imagens/branco.png" id="" style="padding-left: 1%"/>
<br>
...
<div id="div1">
<div  id="div2" style="width:80%; background-color:#cd1414; margin-left:5%; height:30px; border-bottom:none; box-shadow:0px 0px 12px 0px rgba(47, 50, 50, 0.71); border-bottom:solid;  border-color: #C30; border-width:3.5px; margin: 200px auto 0 auto; ">
...
<input type="text" id="iconemail" style="margin-left:5%; width:70%; background-color:#cd1414; border-bottom-color: #C30; opacity:0.75; height:30px; padding-left:2%; color:#FFFFFF;"/>
...
<div id="div_avisa">
<div  id="div_avisa_topo" style="width:80%; background-color:#cd1414; margin-left:5%; height:30px; border-bottom:none; box-shadow:0px 0px 12px 0px rgba(47, 50, 50, 0.71); border-bottom:solid;  border-color: #C30; border-width:3.5px; margin: 200px auto 0 auto; ">
<p align="center" style="color:#FFFFFF; line-height:30px;">Alertar Vencimento<img src="imagens/cancelar.png" style="float:right; padding-right: 5%; padding-top:6px;" onClick="funcao_img()" /></p>
</div>
<div style="width:80%; background-color:#f3f3f3; margin-left:5%; height:150px;  border-top:none;box-shadow:0px 0px 12px 0px rgba(47, 50, 50, 0.71); margin: 0 auto 0 auto;">
<br>
<p  align="center">Quando é o vencimento desta despesa? (alertaremos 1 semana antes, na página principal) </p><br>
